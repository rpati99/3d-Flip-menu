...
class ContainerController: UIViewController {
  ...
  init(sideMenu: UIViewController, center: UINavigationController) {
    ...
    override func viewDidLoad() {
        ...
        print("DBG: Camera postion \(scnView.pointOfView?.position.x), \(scnView.pointOfView?.position.y), \(scnView.pointOfView?.position.z)")
        print("DBG: Camera rotation \(scnView.pointOfView?.rotation.x), \(scnView.pointOfView?.rotation.y), \(scnView.pointOfView?.rotation.z)")
